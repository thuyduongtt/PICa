...
class PICa_OKVQA:
    def __init__(self, args):
        ...
        self.traincontext_caption_dict, self.traincontext_answer_dict, self.traincontext_question_dict = \
            load_anno('%s/captions_train2014.json' % args.coco_path, '%s/mscoco_train2014_annotations.json' % args.coco_path, '%s/OpenEnded_mscoco_train2014_questions.json' % args.coco_path)
...
def main():
    ...
    parser.add_argument('--engine', type=str, default='ada', help='api engine; https://openai.com/api/')
